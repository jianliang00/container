...
public protocol Runtime_V1_RuntimeServiceClientProtocol: GRPCClient {
  ...
  func updatePodSandboxResources(
    _ request: Runtime_V1_UpdatePodSandboxResourcesRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Runtime_V1_UpdatePodSandboxResourcesRequest, Runtime_V1_UpdatePodSandboxResourcesResponse>
}
...
extension Runtime_V1_RuntimeServiceClientProtocol {
  ...
  ///
  /// - Parameters:
  ///   - request: Request to send to UpdatePodSandboxResources.
  ///   - callOptions: Call options.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  public func updatePodSandboxResources(
    ...
    return self.makeUnaryCall(
      path: Runtime_V1_RuntimeServiceClientMetadata.Methods.updatePodSandboxResources.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
      interceptors: self.interceptors?.makeUpdatePodSandboxResourcesInterceptors() ?? []
    )
  }
}
...
public final class Runtime_V1_RuntimeServiceClient: Runtime_V1_RuntimeServiceClientProtocol {
  ...
  public var interceptors: Runtime_V1_RuntimeServiceClientInterceptorFactoryProtocol? {
...
public struct Runtime_V1_RuntimeServiceNIOClient: Runtime_V1_RuntimeServiceClientProtocol {
...
public protocol Runtime_V1_RuntimeServiceAsyncClientProtocol: GRPCClient {
  ...
  func makeUpdatePodSandboxResourcesCall(
    _ request: Runtime_V1_UpdatePodSandboxResourcesRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Runtime_V1_UpdatePodSandboxResourcesRequest, Runtime_V1_UpdatePodSandboxResourcesResponse>
}
...
extension Runtime_V1_RuntimeServiceAsyncClientProtocol {
  ...
  public func makeRunPodSandboxCall(
    _ request: Runtime_V1_RunPodSandboxRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_RunPodSandboxRequest, Runtime_V1_RunPodSandboxResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeStopPodSandboxCall(
    _ request: Runtime_V1_StopPodSandboxRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_StopPodSandboxRequest, Runtime_V1_StopPodSandboxResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeRemovePodSandboxCall(
    _ request: Runtime_V1_RemovePodSandboxRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_RemovePodSandboxRequest, Runtime_V1_RemovePodSandboxResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makePodSandboxStatusCall(
    _ request: Runtime_V1_PodSandboxStatusRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_PodSandboxStatusRequest, Runtime_V1_PodSandboxStatusResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeListPodSandboxCall(
    _ request: Runtime_V1_ListPodSandboxRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ListPodSandboxRequest, Runtime_V1_ListPodSandboxResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeContainerStatusCall(
    _ request: Runtime_V1_ContainerStatusRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ContainerStatusRequest, Runtime_V1_ContainerStatusResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeUpdateContainerResourcesCall(
    _ request: Runtime_V1_UpdateContainerResourcesRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_UpdateContainerResourcesRequest, Runtime_V1_UpdateContainerResourcesResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeReopenContainerLogCall(
    _ request: Runtime_V1_ReopenContainerLogRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ReopenContainerLogRequest, Runtime_V1_ReopenContainerLogResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makePortForwardCall(
    _ request: Runtime_V1_PortForwardRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_PortForwardRequest, Runtime_V1_PortForwardResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeContainerStatsCall(
    _ request: Runtime_V1_ContainerStatsRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ContainerStatsRequest, Runtime_V1_ContainerStatsResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeListContainerStatsCall(
    _ request: Runtime_V1_ListContainerStatsRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ListContainerStatsRequest, Runtime_V1_ListContainerStatsResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makePodSandboxStatsCall(
    _ request: Runtime_V1_PodSandboxStatsRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_PodSandboxStatsRequest, Runtime_V1_PodSandboxStatsResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeListPodSandboxStatsCall(
    _ request: Runtime_V1_ListPodSandboxStatsRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ListPodSandboxStatsRequest, Runtime_V1_ListPodSandboxStatsResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeUpdateRuntimeConfigCall(
    _ request: Runtime_V1_UpdateRuntimeConfigRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_UpdateRuntimeConfigRequest, Runtime_V1_UpdateRuntimeConfigResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeCheckpointContainerCall(
    _ request: Runtime_V1_CheckpointContainerRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_CheckpointContainerRequest, Runtime_V1_CheckpointContainerResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeGetContainerEventsCall(
    _ request: Runtime_V1_GetEventsRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncServerStreamingCall<Runtime_V1_GetEventsRequest, Runtime_V1_ContainerEventResponse> {
  ...
  public func makeListMetricDescriptorsCall(
    _ request: Runtime_V1_ListMetricDescriptorsRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ListMetricDescriptorsRequest, Runtime_V1_ListMetricDescriptorsResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeListPodSandboxMetricsCall(
    _ request: Runtime_V1_ListPodSandboxMetricsRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ListPodSandboxMetricsRequest, Runtime_V1_ListPodSandboxMetricsResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeRuntimeConfigCall(
    _ request: Runtime_V1_RuntimeConfigRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_RuntimeConfigRequest, Runtime_V1_RuntimeConfigResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeUpdatePodSandboxResourcesCall(
    _ request: Runtime_V1_UpdatePodSandboxResourcesRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_UpdatePodSandboxResourcesRequest, Runtime_V1_UpdatePodSandboxResourcesResponse> {
    return self.makeAsyncUnaryCall(
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
public struct Runtime_V1_RuntimeServiceAsyncClient: Runtime_V1_RuntimeServiceAsyncClientProtocol {
  public var channel: GRPCChannel
  public var defaultCallOptions: CallOptions
  public var interceptors: Runtime_V1_RuntimeServiceClientInterceptorFactoryProtocol?
...
public protocol Runtime_V1_RuntimeServiceClientInterceptorFactoryProtocol: Sendable {
  ...
  /// - Returns: Interceptors to use when invoking 'updatePodSandboxResources'.
  func makeUpdatePodSandboxResourcesInterceptors() -> [ClientInterceptor<Runtime_V1_UpdatePodSandboxResourcesRequest, Runtime_V1_UpdatePodSandboxResourcesResponse>]
}

public enum Runtime_V1_RuntimeServiceClientMetadata {
  public static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      ...
      Runtime_V1_RuntimeServiceClientMetadata.Methods.updatePodSandboxResources,
    ]
  )
  ...
  public enum Methods {
    ...
    public static let runPodSandbox = GRPCMethodDescriptor(
      name: "RunPodSandbox",
      path: "/runtime.v1.RuntimeService/RunPodSandbox",
      type: GRPCCallType.unary
    )

    public static let stopPodSandbox = GRPCMethodDescriptor(
      name: "StopPodSandbox",
      path: "/runtime.v1.RuntimeService/StopPodSandbox",
      type: GRPCCallType.unary
    )

    public static let removePodSandbox = GRPCMethodDescriptor(
      name: "RemovePodSandbox",
      path: "/runtime.v1.RuntimeService/RemovePodSandbox",
      type: GRPCCallType.unary
    )

    public static let podSandboxStatus = GRPCMethodDescriptor(
      name: "PodSandboxStatus",
      path: "/runtime.v1.RuntimeService/PodSandboxStatus",
      type: GRPCCallType.unary
    )

    public static let listPodSandbox = GRPCMethodDescriptor(
      name: "ListPodSandbox",
    ...
    public static let containerStatus = GRPCMethodDescriptor(
      name: "ContainerStatus",
      path: "/runtime.v1.RuntimeService/ContainerStatus",
      type: GRPCCallType.unary
    )

    public static let updateContainerResources = GRPCMethodDescriptor(
      name: "UpdateContainerResources",
      path: "/runtime.v1.RuntimeService/UpdateContainerResources",
      type: GRPCCallType.unary
    )

    public static let reopenContainerLog = GRPCMethodDescriptor(
      name: "ReopenContainerLog",
      path: "/runtime.v1.RuntimeService/ReopenContainerLog",
      type: GRPCCallType.unary
    )

    public static let execSync = GRPCMethodDescriptor(
      name: "ExecSync",
    ...
    public static let attach = GRPCMethodDescriptor(
      name: "Attach",
      path: "/runtime.v1.RuntimeService/Attach",
      type: GRPCCallType.unary
    )

    public static let portForward = GRPCMethodDescriptor(
      name: "PortForward",
      path: "/runtime.v1.RuntimeService/PortForward",
      type: GRPCCallType.unary
    )

    public static let containerStats = GRPCMethodDescriptor(
      name: "ContainerStats",
      path: "/runtime.v1.RuntimeService/ContainerStats",
      type: GRPCCallType.unary
    )

    public static let listContainerStats = GRPCMethodDescriptor(
      name: "ListContainerStats",
      path: "/runtime.v1.RuntimeService/ListContainerStats",
      type: GRPCCallType.unary
    )

    public static let podSandboxStats = GRPCMethodDescriptor(
      name: "PodSandboxStats",
      path: "/runtime.v1.RuntimeService/PodSandboxStats",
      type: GRPCCallType.unary
    )

    public static let listPodSandboxStats = GRPCMethodDescriptor(
      name: "ListPodSandboxStats",
      path: "/runtime.v1.RuntimeService/ListPodSandboxStats",
      type: GRPCCallType.unary
    )

    public static let updateRuntimeConfig = GRPCMethodDescriptor(
    ...
    public static let checkpointContainer = GRPCMethodDescriptor(
      name: "CheckpointContainer",
      path: "/runtime.v1.RuntimeService/CheckpointContainer",
      type: GRPCCallType.unary
    )

    public static let getContainerEvents = GRPCMethodDescriptor(
      name: "GetContainerEvents",
      path: "/runtime.v1.RuntimeService/GetContainerEvents",
      type: GRPCCallType.serverStreaming
    )

    public static let listMetricDescriptors = GRPCMethodDescriptor(
      name: "ListMetricDescriptors",
      path: "/runtime.v1.RuntimeService/ListMetricDescriptors",
      type: GRPCCallType.unary
    )

    public static let listPodSandboxMetrics = GRPCMethodDescriptor(
      name: "ListPodSandboxMetrics",
      path: "/runtime.v1.RuntimeService/ListPodSandboxMetrics",
      type: GRPCCallType.unary
    )

    public static let runtimeConfig = GRPCMethodDescriptor(
      name: "RuntimeConfig",
      path: "/runtime.v1.RuntimeService/RuntimeConfig",
      type: GRPCCallType.unary
    )

    public static let updatePodSandboxResources = GRPCMethodDescriptor(
      name: "UpdatePodSandboxResources",
      path: "/runtime.v1.RuntimeService/UpdatePodSandboxResources",
      type: GRPCCallType.unary
    )
  }
}
...
public protocol Runtime_V1_ImageServiceClientProtocol: GRPCClient {
  var serviceName: String { get }
...
public final class Runtime_V1_ImageServiceClient: Runtime_V1_ImageServiceClientProtocol {
  private let lock = Lock()
  private var _defaultCallOptions: CallOptions
  ...
  public var interceptors: Runtime_V1_ImageServiceClientInterceptorFactoryProtocol? {
    get { self.lock.withLock { return self._interceptors } }
    set { self.lock.withLockVoid { self._interceptors = newValue } }
  }
...
public struct Runtime_V1_ImageServiceNIOClient: Runtime_V1_ImageServiceClientProtocol {
  public var channel: GRPCChannel
  public var defaultCallOptions: CallOptions
  public var interceptors: Runtime_V1_ImageServiceClientInterceptorFactoryProtocol?
...
/// ImageService defines the public APIs for managing images.
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
public protocol Runtime_V1_ImageServiceAsyncClientProtocol: GRPCClient {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Runtime_V1_ImageServiceClientInterceptorFactoryProtocol? { get }
...
extension Runtime_V1_ImageServiceAsyncClientProtocol {
  ...
  public func makeListImagesCall(
    _ request: Runtime_V1_ListImagesRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ListImagesRequest, Runtime_V1_ListImagesResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeImageStatusCall(
    _ request: Runtime_V1_ImageStatusRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ImageStatusRequest, Runtime_V1_ImageStatusResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeRemoveImageCall(
    _ request: Runtime_V1_RemoveImageRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_RemoveImageRequest, Runtime_V1_RemoveImageResponse> {
    return self.makeAsyncUnaryCall(
  ...
  public func makeImageFsInfoCall(
    _ request: Runtime_V1_ImageFsInfoRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Runtime_V1_ImageFsInfoRequest, Runtime_V1_ImageFsInfoResponse> {
    return self.makeAsyncUnaryCall(
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
public struct Runtime_V1_ImageServiceAsyncClient: Runtime_V1_ImageServiceAsyncClientProtocol {
  public var channel: GRPCChannel
  public var defaultCallOptions: CallOptions
  public var interceptors: Runtime_V1_ImageServiceClientInterceptorFactoryProtocol?
...
public protocol Runtime_V1_ImageServiceClientInterceptorFactoryProtocol: Sendable {
...
public enum Runtime_V1_ImageServiceClientMetadata {
  public static let serviceDescriptor = GRPCServiceDescriptor(
    name: "ImageService",
  ...
  public enum Methods {
    public static let listImages = GRPCMethodDescriptor(
      name: "ListImages",
      path: "/runtime.v1.ImageService/ListImages",
      type: GRPCCallType.unary
    )

    public static let imageStatus = GRPCMethodDescriptor(
      name: "ImageStatus",
      path: "/runtime.v1.ImageService/ImageStatus",
      type: GRPCCallType.unary
    )

    public static let pullImage = GRPCMethodDescriptor(
      name: "PullImage",
      path: "/runtime.v1.ImageService/PullImage",
      type: GRPCCallType.unary
    )

    public static let removeImage = GRPCMethodDescriptor(
      name: "RemoveImage",
      path: "/runtime.v1.ImageService/RemoveImage",
      type: GRPCCallType.unary
    )

    public static let imageFsInfo = GRPCMethodDescriptor(
      name: "ImageFsInfo",
...
public protocol Runtime_V1_RuntimeServiceProvider: CallHandlerProvider {
  ...
  /// This request is treated as best effort, and failure will not block the
  /// Kubelet with proceeding with a resize.
  func updatePodSandboxResources(request: Runtime_V1_UpdatePodSandboxResourcesRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Runtime_V1_UpdatePodSandboxResourcesResponse>
}
...
extension Runtime_V1_RuntimeServiceProvider {
  ...
  public func handle(
    ...
    case "UpdatePodSandboxResources":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Runtime_V1_UpdatePodSandboxResourcesRequest>(),
        responseSerializer: ProtobufSerializer<Runtime_V1_UpdatePodSandboxResourcesResponse>(),
        interceptors: self.interceptors?.makeUpdatePodSandboxResourcesInterceptors() ?? [],
        userFunction: self.updatePodSandboxResources(request:context:)
      )
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
public protocol Runtime_V1_RuntimeServiceAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Runtime_V1_RuntimeServiceServerInterceptorFactoryProtocol? { get }
...
extension Runtime_V1_RuntimeServiceAsyncProvider {
  ...
  public var interceptors: Runtime_V1_RuntimeServiceServerInterceptorFactoryProtocol? {
    return nil
  }
  ...
  public func handle(
    ...
    case "UpdatePodSandboxResources":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Runtime_V1_UpdatePodSandboxResourcesResponse>(),
        interceptors: self.interceptors?.makeUpdatePodSandboxResourcesInterceptors() ?? [],
        wrapping: { try await self.updatePodSandboxResources(request: $0, context: $1) }
      )
...
public protocol Runtime_V1_RuntimeServiceServerInterceptorFactoryProtocol: Sendable {
  ...
  /// - Returns: Interceptors to use when handling 'updatePodSandboxResources'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeUpdatePodSandboxResourcesInterceptors() -> [ServerInterceptor<Runtime_V1_UpdatePodSandboxResourcesRequest, Runtime_V1_UpdatePodSandboxResourcesResponse>]
}

public enum Runtime_V1_RuntimeServiceServerMetadata {
  public static let serviceDescriptor = GRPCServiceDescriptor(
    name: "RuntimeService",
    fullName: "runtime.v1.RuntimeService",
    methods: [
      ...
      Runtime_V1_RuntimeServiceServerMetadata.Methods.updatePodSandboxResources,
    ]
  )
...
///
/// To build a server, implement a class that conforms to this protocol.
public protocol Runtime_V1_ImageServiceProvider: CallHandlerProvider {
...
/// To implement a server, implement an object which conforms to this protocol.
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
public protocol Runtime_V1_ImageServiceAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Runtime_V1_ImageServiceServerInterceptorFactoryProtocol? { get }
...
extension Runtime_V1_ImageServiceAsyncProvider {
  ...
  public var interceptors: Runtime_V1_ImageServiceServerInterceptorFactoryProtocol? {
    return nil
  }
...
public protocol Runtime_V1_ImageServiceServerInterceptorFactoryProtocol: Sendable {
...
public enum Runtime_V1_ImageServiceServerMetadata {
  public static let serviceDescriptor = GRPCServiceDescriptor(
    name: "ImageService",
    fullName: "runtime.v1.ImageService",
    methods: [
