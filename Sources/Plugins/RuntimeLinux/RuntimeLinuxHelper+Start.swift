            ...
            do {
                ...
                let mainServer = XPCServer(
                    ...
                    routes: [
                        ...
                        RuntimeRoutes.removeWorkload.rawValue: XPCServer.route(server.removeWorkload),
                        RuntimeRoutes.state.rawValue: XPCServer.route(server.state),
                        RuntimeRoutes.inspectWorkload.rawValue: XPCServer.route(server.inspectWorkload),
