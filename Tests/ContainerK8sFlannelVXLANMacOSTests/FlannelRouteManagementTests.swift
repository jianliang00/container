...
struct FlannelRouteManagementTests {
    ...
    func addsExactPodCIDRRouteWhenLookupFallsBackToDefault() throws {
        ...
        try manager.ensureRoute(podCIDR: "10.244.8.17/24", interface: "utun4")
    ...
    func addsExactPodCIDRRouteWhenLookupFindsOnlyABroaderRoute() throws {
        ...
        try manager.ensureRoute(podCIDR: "10.244.8.0/24", interface: "utun4")
    ...
    func doesNotDeleteDefaultRouteWhenExactPodCIDRRouteIsAbsent() throws {
        ...
        try manager.removeRoute(podCIDR: "10.244.8.0/24", interface: "utun4")
    ...
    func failsClosedWhenRouteQueryFailsOrReturnsMalformedOutput() {
        ...
        #expect(throws: FlannelVXLANError.self) {
            try failedQueryManager.removeRoute(podCIDR: "10.244.8.0/24", interface: "utun4")
        }
        ...
        #expect(throws: FlannelVXLANError.self) {
            try malformedQueryManager.ensureRoute(podCIDR: "10.244.8.0/24", interface: "utun4")
        }
    ...
    func acceptsConcurrentAddOrDeleteWhenTheExactPostconditionIsSatisfied() throws {
        ...
        try addManager.ensureRoute(podCIDR: "10.244.8.0/24", interface: "utun4")
        ...
        try deleteManager.removeRoute(podCIDR: "10.244.8.0/24", interface: "utun4")
...
private final class RouteCommandScript: @unchecked Sendable {
    struct Step: Sendable {
        ...
        static func get(_ output: String) -> Self {
            Self(arguments: ["-n", "get", "-net", "10.244.8.0/24"], output: output, errorMessage: nil)
        }

        static func getFailure() -> Self {
            Self(
                arguments: ["-n", "get", "-net", "10.244.8.0/24"],
                output: "",
        ...
        static func add() -> Self {
            Self(
                arguments: ["-n", "add", "-net", "10.244.8.0/24", "-interface", "utun4"],
                output: "",
                errorMessage: nil
            )
        }
        ...
        static func delete() -> Self {
            Self(
                arguments: ["-n", "delete", "-net", "10.244.8.0/24", "-interface", "utun4"],
                output: "",
                errorMessage: nil
            )
        }
